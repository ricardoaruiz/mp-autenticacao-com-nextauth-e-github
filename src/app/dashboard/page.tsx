...
export default function DashboardPage() {
  return (
    <section className="container flex flex-col flex-nowrap mx-auto min-h-screen bg-right-bottom bg-no-repeat pt-10 md:pt-24">
      ...
      <div className="flex content-start flex-col items-center md:items-start bg-dashboard-squares bg-no-repeat bg-[right_top_50px] md:bg-right-top min-h-[467px] w-full mt-6 mb:mt-10 bg-[length:400px_400px] md:bg-[length:600px_600px] ">
